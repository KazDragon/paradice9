...
public :
        ...
        : string_to_elements_parser::base_type(elements_)
    {
        ...
        intensity_directive_ =
            ( ( lit("x") | lit("=") )
                >> attr(odin::ansi::graphics::intensity::normal) )
          | ( ( lit(">")            )
                >> attr(odin::ansi::graphics::intensity::bold) )
          | ( ( lit("<")            )
                >> attr(odin::ansi::graphics::intensity::faint) )
            ;
        ...
        polarity_directive_ =
            ( ( lit("x") | lit("+") )
                >> attr(odin::ansi::graphics::polarity::positive) )
          | ( ( lit("-")            )
                >> attr(odin::ansi::graphics::polarity::negative) )
            ;
        ...
        underlining_directive_ =
            ( ( lit("x") | lit("-") )
                >> attr(odin::ansi::graphics::underlining::not_underlined) )
          | ( ( lit("+")            )
                >> attr(odin::ansi::graphics::underlining::underlined) )
            ;
