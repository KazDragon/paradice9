#ifndef MUNIN_STRING_TO_ELEMENTS_FIXTURE_HPP_
#define MUNIN_STRING_TO_ELEMENTS_FIXTURE_HPP_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

class munin_string_to_elements_fixture : public CppUnit::TestFixture
{
public :
    CPPUNIT_TEST_SUITE(munin_string_to_elements_fixture);
