...
class naws_client : public odin::telnet::client_option
{
    ...
    // ======================================================================
    public :
        naws_client(boost::shared_ptr<odin::telnet::stream> stream);
    ...
    // ======================================================================
    public :
        typedef boost::function<void (unsigned short, unsigned short)> fn;
        // ==================================================================
        // ON_SIZE_SET
        //  FUNCTION : Set the callback for when the server part of the NAWS
        //             option announces a change in size.
        // ==================================================================
        void on_size_set(fn f);
