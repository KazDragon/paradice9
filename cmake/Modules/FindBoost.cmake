...
#  BOOST_LOG_FOUND                     True if Boost Log was found.
...
#  BOOST_RANDOM_FOUND                  True if Boost Random was found.
...
#  BOOST_LOG_LIBRARY                   The Boost Log library.
...
#  BOOST_RANDOM_LIBRARY                The Boost Random library.
...
#  BOOST_SYSTEM_LIBRARY                The Boost System library.
...
if (BOOST_LIBRARIES AND BOOST_INCLUDE_DIRS)
  ...
  foreach (TMP_BOOST_LIBRARIES_SUFFIX "" ${BOOST_LIBRARIES_SUFFIXES})
    ...
    if (NOT BOOST_LOG_LIBRARY)
      find_library(BOOST_LOG_LIBRARY
        NAMES
          boost_log${TMP_BOOST_LIBRARIES_SUFFIX}
        PATHS
          ${BOOST_LIBRARIES_SEARCH_DIRS}
      )
    endif (NOT BOOST_LOG_LIBRARY)
    ...
    if (NOT BOOST_RANDOM_LIBRARY)
      find_library(BOOST_RANDOM_LIBRARY
        NAMES
          boost_random${TMP_BOOST_LIBRARIES_SUFFIX}
        PATHS
          ${BOOST_LIBRARIES_SEARCH_DIRS}
      )
    endif (NOT BOOST_RANDOM_LIBRARY)
