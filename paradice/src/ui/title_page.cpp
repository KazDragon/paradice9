...
std::vector<terminalpp::string> const main_image = {
    R"(       \[2__ _.--..--._ _\x                  _)"_ets,
    R"(    \[2.-' _/   _/\\_   \\_'-._\x     |/ _._  | \\.__. _  _ ._ /_)"_ets,
    R"(    \[2|__ /   _/\[3\\__/\[2\\_   \\__|\x    |\\(_|/_ |_/|(_|(_|(_)| |_>)"_ets,
    R"(       \[2|___/\[3\\_\\__/\[2  \\___|\x                      _|)"_ets,
    R"(              \[3\\__/\x         ___                   ___           \i>___)"_ets,
    R"(              \[3\\__/\x        / _ \\___ ________ ____/ (_)______   \i>/ _ \\)"_ets,
    R"(               \[3\\__/\x      / ___/ _ `/ __/ _ `/ _  / / __/ -_)  \i>\\_, /)"_ets,
    R"(                \[3\\__/\x    /_/   \\_,_/_/  \\_,_/\\_,_/_/\\__/\\__/  \i>/___/)"_ets,
    R"(             \[3____\\__/___\x                              v2.0)"_ets,
    R"(       \[3. - '             ' -.)"_ets,
    R"(      \[3/                      \\)"_ets,
    R"(\[4~~~~~~~  ~~~~~ ~~~~~  ~~~ ~~~  ~~~~~)"_ets,
    R"(\[4  ~~~   ~~~~~   ~~~~   ~~ ~  ~ ~ ~~~)"_ets,
    ...
    login_button_(munin::make_button(" Login "))
{
    ...
    auto const buttons_container = munin::view(
        ...
        munin::compass_layout::heading::centre,
        munin::view(
            munin::make_vertical_strip_layout(), new_button_, login_button_),
