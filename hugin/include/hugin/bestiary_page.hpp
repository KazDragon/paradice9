...
public :
    ...
    //* =====================================================================
    boost::signals2::signal<void (std::shared_ptr<paradice::beast> const &)> on_clone;

    //* =====================================================================
    /// \fn on_edit
    /// \brief Called when the 'edit' button is pressed.
    //* =====================================================================
    boost::signals2::signal<void (std::shared_ptr<paradice::beast> const &)> on_edit;

    //* =====================================================================
    /// \fn on_fight
    /// \brief Called when the 'fight!' button is pressed.
    //* =====================================================================
    boost::signals2::signal<void (std::shared_ptr<paradice::beast> const &)> on_fight;

    //* =====================================================================
    /// \fn on_delete
    /// \brief Called when the 'delete' button is pressed.
    //* =====================================================================
    boost::signals2::signal<void (std::shared_ptr<paradice::beast> const &)> on_delete;
