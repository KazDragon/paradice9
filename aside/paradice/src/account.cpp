...
// SET_NAME
// ==========================================================================
void account::set_name(std::string const &name)
{
    name_ = name;
}
...
// SET_PASSWORD
// ==========================================================================
void account::set_password(std::string const &password)
{
...
// PASSWORD_MATCH
// ==========================================================================
bool account::password_match(std::string const &password)
{
...
// ADD_CHARACTER
// ==========================================================================
void account::add_character(std::string const &character_name)
{
...
// REMOVE_CHARACTER
// ==========================================================================
void account::remove_character(std::string const &character_name)
{
    characters_.erase(std::remove(
