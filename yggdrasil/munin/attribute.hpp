...
struct attribute
{
    ...
    struct low_colour
    {
        ...
        low_colour(yggdrasil::graphics::colour colour)
          : value_(colour)
        {
        };
    ...
    struct high_colour
    {
        ...
        high_colour(yggdrasil::u8 red, yggdrasil::u8 green, yggdrasil::u8 blue)
            : red_(red)
            , green_(green)
            , blue_(blue)
        {
    ...
    struct greyscale_colour
    {
        ...
        explicit greyscale_colour(yggdrasil::u8 shade)
            : shade_(shade)
        {
        }
