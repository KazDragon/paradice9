...
// ==========================================================================
s32 frame::get_top_border_height() const
{
...
// ==========================================================================
s32 frame::get_bottom_border_height() const
{
...
// ==========================================================================
s32 frame::get_left_border_width() const
{
...
// ==========================================================================
s32 frame::get_right_border_width() const
{
