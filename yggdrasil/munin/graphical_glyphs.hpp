...
namespace yggdrasil { namespace munin { inline namespace graphical_glyphs {
    
// ==========================================================================
// USAGE:
//  Simply refer to the glyph named in the DECLARE_XXX_GLYPH.
...
DECLARE_G0SCO_GLYPH(inverted_exclamation_mark, 173);
